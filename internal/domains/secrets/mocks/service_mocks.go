...
func (m *MockService) GetPage(ctx context.Context, ownerID models.UserID, page, limit uint64) (*secrets.Page[models.Secret], error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetPage(ctx, ownerID, page, limit any) *MockServiceGetPageCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPage", reflect.TypeOf((*MockService)(nil).GetPage), ctx, ownerID, page, limit)
